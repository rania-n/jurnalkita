@php
    ...
    // Status "Sedang JP berapa" / Istirahat untuk topbar biasa
    ...
    // Data waktu untuk bar sticky Guru Piket (muncul di bawah header di semua halaman)
    if ($isPiketHariIni) {
...
<div class="sticky top-0 z-30">
    ...
    @if ($isPiketHariIni)
        {{-- Bar waktu & keterangan status jam pelajaran/istirahat khusus Guru Piket.
             Layout mobile-first: statusWaktu paling menonjol di kiri, tanggal & jam di kanan. --}}
